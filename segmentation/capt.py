...
class CenterAttentionPyramidTransformer(nn.Module):
    def __init__(self, img_size=224, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
                 ...
                 depths=[3, 4, 6, 3], num_stages=4, linear=False, pretrained=None):
        super().__init__()
...
@BACKBONES.register_module()
class capt_micro(CenterAttentionPyramidTransformer):
    def __init__(self, **kwargs):
        super(capt_micro, self).__init__(
            embed_dims=[32, 64, 160, 256], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 3, 3, 2],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])
...
@BACKBONES.register_module()
class capt_tiny(CenterAttentionPyramidTransformer):
    def __init__(self, **kwargs):
        super(capt_tiny, self).__init__(
            embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 4, 3, 2],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])
...
# @BACKBONES.register_module()
# class capt_small(CenterAttentionPyramidTransformer):
#     def __init__(self, **kwargs):
#         super(capt_small, self).__init__(
#             embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
#             qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 8, 9, 3],
#             drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])
...
class capt_small(CenterAttentionPyramidTransformer):
    def __init__(self, **kwargs):
        super(capt_small, self).__init__(
            embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 6, 13, 3],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])



# @BACKBONES.register_module()
# class capt_medium(CenterAttentionPyramidTransformer):
#     def __init__(self, **kwargs):
#         super(capt_medium, self).__init__(
#             embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
#             qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 5, 19, 3],
#             drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])
...
class capt_medium(CenterAttentionPyramidTransformer):
    def __init__(self, **kwargs):
        super(capt_medium, self).__init__(
            embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 8, 30, 3],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])

# @register_model
# def capt_medium(pretrained=False, **kwargs):         # source:45.2M 6.9G ours:45.0 M 9.66G
#     model = CenterAttentionPyramidTransformer(
#         embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
...
@BACKBONES.register_module()
class capt_large(CenterAttentionPyramidTransformer):
    def __init__(self, **kwargs):
        super(capt_large, self).__init__(
            embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 8, 40, 3],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])
...
@BACKBONES.register_module()
class capt_huge(CenterAttentionPyramidTransformer):
    def __init__(self, **kwargs):
        super(capt_huge, self).__init__(
            embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 10, 56, 3],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])

# @register_model
# def capt_huge(pretrained=False, **kwargs):             # source:82.0M 11.8G ours:82，85M 16.38G
#     model = CenterAttentionPyramidTransformer(
#         embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4], qkv_bias=True,
#         norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 10, 56, 3], **kwargs)
#     model.default_cfg = _cfg()
#
#     return model
